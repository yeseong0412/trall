  ...
  return (
    ...
    >
      <style jsx global>{`
        ...
        .confetti.active {
          animation: confettiRain var(--confetti-time, 0s) ease-out forwards;
        }
      `}</style>
      ...
      <div className="md:hidden flex-1 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative py-8 px-4">
          ...
          <div
            ...
            `}
            style={{
              boxShadow: isAnimating ? `0 0 40px ${style.glowColor}` : 'none',
            }}
            onClick={handleCharacterClick}
          >
            <img 
          ...
          <div className="mt-8 w-full">
            <Link href={`/${opponent.toLowerCase()}`} className="w-full">
      ...
      <div className="confetti-container">
        {Array.from({ length: 50 }).map((_, i) => (
          <div
            key={i}
            className={`confetti ${gameState.clicks % 5 === 0 ? 'active' : ''}`}
            style={{
