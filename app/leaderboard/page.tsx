...
export default function LeaderboardPage() {
  ...
  useEffect(() => {
    const aClicks = localStorage.getItem('characterAClicks');
    const bClicks = localStorage.getItem('characterBClicks');
    
    if (aClicks) setCharacterAClicks(parseInt(aClicks, 10));
    if (bClicks) setCharacterBClicks(parseInt(bClicks, 10));
  }, []);
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-5xl font-bold mb-2">순위표</h1>
